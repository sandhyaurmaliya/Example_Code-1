function inloggen(){
    ...
    var inloggen_waarden = {
        "async": true,
        "crossDomain": true,
        "url": "https://api.data-web.be/user/login?project=CFNIOuwTJGyR",
        "method": "POST",
        "headers": {},
        "data": {
          "email": email,
      ...
      .done(function (response) {
        ...
        document.location = "product_beheren_met_database.html"
      })
...
function registreren(){
    ...
    var aanmelden_waarden = {
        "async": true,
        "crossDomain": true,
        "url": "https://api.data-web.be/user/register?project=CFNIOuwTJGyR",
        "method": "POST",
        "headers": {},
        "data": {
